...
import { Position, Velocity, Health, CollisionRadius, Team, Dead, } from "./arena/components.js";
import { movementSystem, collisionSystem, combatSystem, deathSystem, } from "./arena/systems.js";
// ── Registration helper ──
function registerArenaComponents() {
...
function createFighter(world, teamId, x, z, speed, angle) {
...
describe("Arena Brawl — Performance", () => {
    ...
    it("100 entities, 1000 ticks complete in under 5 seconds", () => {
        ...
        for (let i = 0; i < 100; i++) {
            ...
            createFighter(world, i % 2, Math.cos(angle) * 50, Math.sin(angle) * 50, 5, angle + Math.PI);
        }
...
//# sourceMappingURL=ArenaBrawl.test.js.map